...
local web = true
local user = "Deni210" -- change if you're using a fork
...
local releaseInfo = HttpService:JSONDecode(game:HttpGetAsync("https://api.github.com/repos/" .. user .. "/test/releases"))[1]
            ...
            elseif web then
                if readFile and writeFile then
                    ...
                    if (isFile and not isFile(file)) or not importCache[asset] then
                        content = game:HttpGetAsync("https://raw.githubusercontent.com/" .. user .. "/test/" .. branch .. '/' .. asset .. ".lua")
                    ...
                    assets = { loadstring(game:HttpGetAsync("https://raw.githubusercontent.com/" .. user .. "/test/" .. branch .. '/' .. asset .. ".lua"), asset .. '.lua')() }
                end
            else
